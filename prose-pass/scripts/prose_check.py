...
CHECKS = [
    ...
    ("ai-vocab", "ai", "AI: era vocabulary", _C(r"\bdelv(?:e|es|ing)\b|\btapestry\b|\bgarner(?:ed|ing)\b|\bgarners? (?:attention|acclaim|praise|support|interest)\b|\bmultifaceted\b|\bintricacies\b|\bintricate interplay\b|\bever-evolving\b|\bseamlessly\b|\bshowcas(?:e|es|ing)\b"), "plain register: examine, mix, earn, complex, smoothly, show — one hit is weak signal; two or more warrants a pass"),
